...
export async function getServerSideProps(ctx: GetServerSidePropsContext) {
    ...
    let articles = data.filter((x) => x.postYear === +ctx.params.year && x.postMonth === +ctx.params.month);
...
export default function MonthList(props: { articles: ArticleType[]; year: string; month: string }) {
    return (
        <>
            <FinalNavbar />
