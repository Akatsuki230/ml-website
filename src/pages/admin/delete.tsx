...
export default function AdminDeleteRedirect(props: AdminPropertiesProps) {
    ...
    return (
        <main className="max-w-3xl mx-auto">
            <h1 className="text-2xl font-bold mb-4">Are you sure you want to
                delete {props.redirect.label}?</h1>
            <div className="flex space-x-4">
                <button className="bg-red-800 hover:bg-red-500 active:bg-red-700 px-2 py-1 rounded-lg"
                        onClick={performDelete}>Yes
                </button>
                <button className="bg-green-800 hover:bg-green-500 active:bg-green-700 px-2 py-1 rounded-lg"
                        onClick={performBack}>No
                </button>
            </div>
        </main>
    )
