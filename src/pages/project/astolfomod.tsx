    ...
    return (
        <div className={inter.className}>
            <Head>
                ...
                <meta name="og:description" content="Astolfo Forge mod adds lots of femboys into Minecraft!" />
                <meta name="og:image" content="https://mldkyt.com/astolfomod_crowd.webp" />
