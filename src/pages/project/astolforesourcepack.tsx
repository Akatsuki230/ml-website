  ...
  return (
    <div className={inter.className}>
      ...
      <Container>
        ...
        <p>
          This resource pack changes the Minecraft loading screen, logo, totem
          of undying and ending screen to be more Astolfo themed.
        </p>
        ...
        <Button
          as="a"
          href="https://github.com/mldkyt/AstolfoResourcePackInstaller/releases/download/release-1.0/AstolfoResourcePackInstaller.exe"
        >
        ...
        <Button
          as="a"
          href="https://github.com/mldkyt/AstolfoResourcePack/releases/tag/releases"
          variant="secondary"
        >
