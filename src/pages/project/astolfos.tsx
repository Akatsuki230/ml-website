  ...
  return (
    <div className={inter.className}>
      ...
      <Container>
        ...
        <p>
          This script changes the OS name, KDE splash screen, GRUB
          configuration, neofetch configuration and terminal style.
        </p>
        ...
        <Button
          as="a"
          href="https://github.com/mldkyt/AstolfOS/wiki/Automatic-Installation-(Ubuntu-only)"
        >
        ...
        <Button
          variant="secondary"
          as="a"
          href="https://github.com/mldkyt/AstolfOS/wiki/Manual-Installation"
        >
