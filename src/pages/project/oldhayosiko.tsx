...
export default function OldTruckSounds() {
    return (
        <>
            ...
            <p style={itemStyle} className="rounded-lg m-2 px-2 py-1 text-white border-2 border-red-500">This mod is not compatible with any other mods that affect the Hayosiko van. Please make sure to remove any conflicting mods before using this mod.</p>
            <br />
