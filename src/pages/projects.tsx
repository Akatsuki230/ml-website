        ...
        <>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            ...
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white" href="/project/asphaltroads">Visit
                        project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            whileHover={{scale: 1.1}}
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white" href="/project/msctweaks">Visit
                        project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            whileHover={{scale: 1.1}}
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white" href="/project/oldcarsounds">Visit
                        project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                    ...
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white"
                          href="/project/oldhighwaycars">Visit project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            whileHover={{scale: 1.1}}
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white" href="/project/oldhayosiko">Visit
                        project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            whileHover={{scale: 1.1}}
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white" href="/project/oldworld">Visit
                        project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            ...
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white"
                          href="/project/kekmetmoregears">Visit project's page</Link>
                </motion.div>
            </div>
            ...
            <div style={itemStyle} className="bg-black border-2 border-white m-4 py-2 rounded-lg drop-shadow-none">
                ...
                <motion.div className="w-max ml-2"
                            ...
                            whileTap={{scale: 0.9}}>
                    <Link className="bg-black rounded-lg p-0.5 px-1 border-2 border-white"
                          href="/project/kekmetspeedometer">Visit project's page</Link>
                </motion.div>
            </div>
