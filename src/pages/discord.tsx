...
export default function Discord() {
  return (
    <div className={inter.className}>
      ...
      <h1 className="mt-4 text-5xl text-center font-bold text-white">mldkyt's Discord server</h1>
      ...
      <p className="px-8 text-white">There is a forum channel where you can get modding support for My Summer Car mods
