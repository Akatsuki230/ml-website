      ...
      <Container>
        ...
        {loadedStats ? (
          ...
          <>
            <p>
              {statsError ? (
                <>There was an error loading the stats</>
              ) : (
        ...
        <Alert variant="warning">
          <h4>NOTE</h4>
          <p>
            I am not the official owner of this Discord server, but it is/was
            Mine
          </p>
          <p>
            A member going by the name of <strong>brimoflafi</strong> (which is
            also very cute) is the new owner of the server.
          </p>
          <p>
            The reason behind this is that I do not have time to maintain a
            server, let alone be an owner of a server.
          </p>
          <p>
            This doesn't mean I'm quitting or anything, when I get free time, I
            might be active for a while.
          </p>
          <small>
        ...
        <p>
          This server has a custom Discord bot which has ChatPoints, CutePoints
          and more.
        </p>
        <Alert variant="warning">
          This bot is in very slow development and isn't updated much.
        </Alert>
        <p>
        ...
        <Modal
          show={joinWarningShown}
          onHide={() => setJoinWarningShown(false)}
        >
          <Modal.Dialog>
            ...
            <Modal.Body>
              <Alert variant="warning">
                ...
                <p>
                  This server is meant to be a welcoming place for everyone.
                </p>
              </Alert>
            </Modal.Body>
            <Modal.Footer>
              ...
              <Button
                variant="secondary"
                onClick={() => setJoinWarningShown(false)}
              >
                Nevermind
              </Button>
            </Modal.Footer>
