...
import { Accordion, Alert, Button, Container, Image, Modal } from "react-bootstrap";
    ...
    <div className={inter.className}>
     ...
     crossOrigin="anonymous"></script>
      ...
      <Container>
        ...
        <Button onClick={() => setJoinWarningShown(true)}>
          Join now
        </Button>
        ...
        {loadedStats ? (
          ...
          <>
            <p>
              {statsError ? <>There was an error loading the stats</> : <>Loading member stats...</>}
            </p>
          </>
        )}
        ...
        <Alert variant="warning">
          ...
          <p>A member going by the name of <strong>brimoflafi</strong> (which is also very cute) is the new owner of the server.</p>
        ...
        <Modal show={joinWarningShown} onHide={() => setJoinWarningShown(false)}>
          <Modal.Dialog>
            ...
            <Modal.Body>
              <Alert variant="warning">
                <p>This server is <strong>NOT</strong> for people who are:</p>
                <ul>
                  <li>Homophobic</li>
                  <li>Transphobic</li>
                  <li>Femboyphobic</li>
            ...
            <Modal.Footer>
              <Button as="a" href="https://discord.gg/JgFNmSwYME">OK, Join</Button>
              <Button variant="secondary" onClick={() => setJoinWarningShown(false)}>Nevermind</Button>
            </Modal.Footer>
          </Modal.Dialog>
        </Modal>
