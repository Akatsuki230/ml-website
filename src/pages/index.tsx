...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className='border-2 border-red-500 p-2 m-2 rounded-lg'>
        <h1 className='text-2xl'>Currently featured My Summer Car mod</h1>
        <h2 className='text-xl'>Asphalt Roads</h2>
        <p className='text-gray-500 text-sm'>Version 1.2 &bull; 19 494 views &bull; 8 015 downloads &bull; Info last updated 29/6/2023</p>
        ...
        <motion.div className='mt-2 mb-1.5 w-max'
          whileHover={{scale: 1.1}}
          whileTap={{scale: 0.9}}>
          <Link href='/project/asphaltroads' className='p-2 px-3 bg-black rounded-lg border-2 border-white'>Open mod page</Link>
        </motion.div>
      </div>
      <h2 className='text-2xl mx-2'>About me</h2>
      <div className='mx-1 flex flex-row flex-wrap'>Hello, I'm mldkyt! I'm available on <YouTube />, <Twitter /> and <Instagram /></div>
      <Watermark />
    </div>
  )
}
