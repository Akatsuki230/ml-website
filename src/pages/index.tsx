  ...
  return (
    <div className={inter.className}>
      ...
      <Container>
        ...
        <p>
          Welcome to mldkyt's website! Start scrolling down to find out more
          about me :3
        </p>
        <ViewTracker />

        <Alert variant="secondary">
          <h2>I have a Discord server</h2>
        ...
        <h1>About me</h1>
        <p>
          mldkyt is a femboy programmer and is an addict to astolfo please don't
          kill me tysm &lt;3
        </p>
        ...
        <div style={{ marginLeft: "8px" }}>
          ...
          <p>
            There's a safe version available, where Astolfo comes to compliment
            you &lt;3
          </p>
          <p>
            The evil version causes your PC to shut down after Astolfo comes for
            you.
          </p>
