...
export const meta: V2_MetaFunction = () => {
  return [
    ...
    {name: 'description', content: 'OldCarSounds is a mod for My Summer Car which returns old sounds from old builds of My Summer Car and puts them in the newest version of the game.'},
