...
export const meta: V2_MetaFunction = () => {
  return [
    ...
    {name: "description", content: "Asphalt Roads is a mod for My Summer Car which replaces dirt roads with asphalt roads."},
...
export default function AsphaltRoads() {
  return (
    <div>
      ...
      <p className="mx-2">Asphalt Roads is a mod for My Summer Car which replaces dirt roads with asphalt roads.</p>
      <img className="rounded-lg ml-4" src="https://staticdelivery.nexusmods.com/mods/2600/images/3670/3670-1691406498-1770392602.png" alt="image i guess"/>
      ...
      <a className="ml-4 px-2 py-1 bg-orange-500 rounded-lg" href="https://www.nexusmods.com/mysummercar/mods/3670">Download</a>
      <p className="ml-4">You can also build it from source on GitHub: </p>
      <a className="ml-4 px-2 py-1 bg-black border-2 border-white rounded-lg" href="https://github.com/mldkyt/AsphaltRoads/releases">Source Code</a>
      <br/>
      <br/>
