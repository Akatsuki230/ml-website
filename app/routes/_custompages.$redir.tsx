    ...
    <>
      {!data.error && (
        <>
          ...
          {(data.themeType == "imageTile" ||
            data.themeType == "imageFit" ||
            data.themeType == "imageStretch") && (
            <div
              className="w-screen h-screen fixed left-0 top-0"
              style={{
                ...
                backgroundSize:
                  data.themeType == "imageStretch"
                    ...
                    : "auto",
                backgroundRepeat:
                  data.themeType == "imageTile" ? "repeat" : "no-repeat",
              }}
            ></div>
          )}
        </>
      ...
      >
        ...
        <div className="mt-2" style={{
          color: data.themeTextColor
        }}>Views: {data.views}</div>
      </div>
      <Navbar sel="" />
    </>
  );
