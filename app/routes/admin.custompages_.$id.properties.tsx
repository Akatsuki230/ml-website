...
export default function AdminCustompagesIdProperties() {
  ...
  return (
    <>
      ...
      <form
        action={`/admin/custompages/${data.customPage.id}/properties`}
        method="post"
      >
        ...
        <input
          ...
          name="id"
          id="id"
          defaultValue={data.customPage.id}
        />
        <br />
        ...
        <input
          ...
          name="label"
          id="label"
          defaultValue={data.customPage.label}
        />
        <br />
        ...
        <input
          ...
          name="url"
          id="url"
          defaultValue={data.customPage.url}
        />
        <br />
        ...
        <select
          ...
          name="type"
          id="type"
          defaultValue={data.customPage.type}
        >
        ...
        <select
          ...
          id="bgType"
          className="bg-black"
          defaultValue={data.customPage.themeType}
        >
        ...
        {data.customPage.themeType == "colour" && (
          <>
            ...
            <input
              ...
              name="bgColour"
              id="bgColour"
              defaultValue={data.customPage.themeBgValue}
            />
          </>
        )}
        ...
        <input
          ...
          name="textColour"
          id="textColour"
          defaultValue={data.customPage.themeTextColor}
        />
        <br />
        ...
        <input
          ...
          min="0"
          max="255"
          defaultValue={data.textBgOpacity}
        />
        <br />
